...
func RunServer(cfg *config.ServerConfig) {
	...
	public.POST("/user/register", authController.Register)
	...
	protected.POST("/text", storageController.Store)
	protected.POST("/credentials", storageController.Store)
	protected.POST("/binary", storageController.Store)
	protected.POST("/cards", storageController.Store)
